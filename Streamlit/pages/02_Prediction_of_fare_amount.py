...
model_dis = pd.read_pickle(r'C:\Users\user\Desktop\daniel\DATA SCIENCE\HENRY\HENRY BOOTCAMP\GRUPAL\streamlit_project\pages\model_dis', compression='bz2')
model_dur = pd.read_pickle(r'C:\Users\user\Desktop\daniel\DATA SCIENCE\HENRY\HENRY BOOTCAMP\GRUPAL\streamlit_project\pages\model_dur', compression='bz2')
model_rate = pd.read_pickle(r'C:\Users\user\Desktop\daniel\DATA SCIENCE\HENRY\HENRY BOOTCAMP\GRUPAL\streamlit_project\pages\model_rate', compression='bz2')
model_tolls = pd.read_pickle(r'C:\Users\user\Desktop\daniel\DATA SCIENCE\HENRY\HENRY BOOTCAMP\GRUPAL\streamlit_project\pages\model_tolls', compression='bz2')
model_air = pd.read_pickle(r'C:\Users\user\Desktop\daniel\DATA SCIENCE\HENRY\HENRY BOOTCAMP\GRUPAL\streamlit_project\pages\model_air', compression='bz2')
model_lin = pd.read_pickle(r'C:\Users\user\Desktop\daniel\DATA SCIENCE\HENRY\HENRY BOOTCAMP\GRUPAL\streamlit_project\pages\model_lin', compression='bz2')

df = pd.read_parquet(r'C:\Users\user\Desktop\daniel\DATA SCIENCE\HENRY\HENRY BOOTCAMP\GRUPAL\streamlit_project\pages\taxi_trip.parquet', 'pyarrow')
zones_lookup = pd.read_parquet(r'C:\Users\user\Desktop\daniel\DATA SCIENCE\HENRY\HENRY BOOTCAMP\GRUPAL\streamlit_project\pages\zones.parquet', 'pyarrow')
...
def main():
    ...
    with st.expander('Contexto'):
        ...
        st.image(r'C:\Users\user\Desktop\daniel\DATA SCIENCE\HENRY\HENRY BOOTCAMP\GRUPAL\streamlit_project\pages\assets\General.png')
        st.write('Modelos generadores de parámetros')
        st.image(r'C:\Users\user\Desktop\daniel\DATA SCIENCE\HENRY\HENRY BOOTCAMP\GRUPAL\streamlit_project\pages\assets\Condicionales.png')
